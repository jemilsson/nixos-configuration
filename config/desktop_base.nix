...
in
{
  ...
  hardware = {
    ...
    opengl = {
      ...
      s3tcSupport = true;
      extraPackages = with pkgs; [ vaapiIntel libvdpau-va-gl vaapiVdpau mesa_noglu libGLU];
      extraPackages32 = with pkgs; [ vaapiIntel libvdpau-va-gl vaapiVdpau mesa_noglu libGLU];
    };
